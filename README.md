...
Still on the roadmap (Phase 2+): axis break, small multiples, drill-down, Top N + Others, JSON theme import, FC-vs-AC overlay. See [`PLAN.md`](PLAN.md) for the full capability map.
